    ...
    <>
        ...
        {menuOpen && (
          <div id="mobile-menu" className="container" style={{ padding: '.5rem 1rem 1rem' }}>
            <nav aria-label="Mobile">
              <a href="#features" style={{ display: 'block', padding: '.5rem 0' }}>
                Features
              </a>
              <a href="#about" style={{ display: 'block', padding: '.5rem 0' }}>
                About
              </a>
              <a href="#contact" style={{ display: 'block', padding: '.5rem 0' }}>
                Contact
              </a>
            </nav>
          </div>
      ...
      <main>
        ...
        <section id="about" className="container">
          ...
          <p className="muted">
            <b>
              Smart Bus Web App giúp kết nối học sinh, phụ huynh, tài xế và nhà trường trong một hệ
              thống quản lý xe buýt thông minh.
            </b>
            <br />
            Theo dõi lộ trình theo thời gian thực, đảm bảo an toàn và tối ưu vận hành dễ dàng trên
        ...
        <section id="contact" className="container">
          ...
          <p className="muted">Liên hệ nhóm 6 qua link dưới</p>
          <p>
            <a
      ...
      <footer>
        ...
        >
          <small className="muted">
            © <span>{year}</span> Bus Smart. All rights reserved, Bancie.
          </small>
